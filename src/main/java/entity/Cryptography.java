...
public class Cryptography {
    ...
    private String alphabet0 = "BdhciEy0aP1Yr2DG3pvk4FN5mT6en7sAj8WquS9UXKCtZIlHLMoxfVzwQbJROg";
    private String alphabet1 = "VPnoi1uRJ2eEr3lAZj4cBIW5hvH6MDKC7FYaf8dLXm9GOzwk0SUsgtybNpTQqx";
    private String alphabet2 = "YCGu1cfz2lpw3KTgq4tvFD5mBZ6NeJW7SiOP8QXd9xAV0jsrbMyknhLoaRUEIH";
    private String alphabet3 = "TpQG1RVC2Ovy3Xkz4YNaS5jhKd6ILqJ7EZAD8FlfB9t0srxWUneiHomgcMPuwb";
    private String alphabet4 = "ZvUcqmgTCBNFhwXuHiSQoJ1kD2VMz3eYrK4pan5OWb6Ps7fA8RLI9E0lGtxdyj";
    private String alphabet5 = "zNYyMjHFOCltaWcAEfU1TQ2eqx3XS4vr5uKD6wim7IVk8pJ9R0ZosLbdgGhBnP";
    private String alphabet6 = "aVFEgIicpMYeLfzyoGBTURDHQXWdKxs1Jb23lP4Nqu5ASn6Zhj7mk8rv9Ct0Ow";
    private String alphabet7 = "BXiEpAYZ0Gla9sjx8KhFT7kcy6beL5mf4ot3nU2NJ1urOIDzwdCMvRgVWqHSPQ";
    private String alphabet8 = "IjVb1lzk2ZvRw3LQF4GEyuY5mWDx6ecqo7XigM8trB9JPK0AahdNHSTpsUnfCO";
    private String alphabet9 = "sxefdMEUIngW1ZorT2vVHw3zcuC4thON5DjFLA6BiYXb7pGlS8ayJ9mq0KPkRQ";
    ...
    public String encrypt(String input, int password) {
        ...
        int keyEncrypt1 = (int) Math.pow((password / 10000) % 10, 10) % 62;
        int keyEncrypt2 = (int) Math.pow((password / 1000) % 10, 10) % 62;
        int keyEncrypt3 = (int) Math.pow((password / 100) % 10, 10) % 62;
        int keyEncrypt4 = (int) Math.pow((password / 10) % 10, 10) % 62;
        int keyEncrypt5 = (int) Math.pow(password % 10, 10) % 62;
