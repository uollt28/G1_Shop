        ...
        <style>
            ...
            *{
            ...
            .cus-info {
                ...
                box-shadow: 20px 20px rgb(222, 221, 221);
                padding: 24px;
                border-radius: 3px;
            }
            ...
            .product-paying-quantity {
                max-width: 60px;
            }
            .product-paying-detail a , .product-paying-order{
                text-decoration: none;
                font-weight: bold;
            }
            .product-paying-detail i {
                font-size: 12px;
            }
            
            .product-paying-status {
                max-width: 50px;
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-8">
                            ...
                            <tbody>
                                <c:forEach items="${listOrderOfCustomer}" var="o">
                                    <tr>
                                        ...
                                        <td class="product-paying-quantity">${o.numberProduct}</td>
                                        <td class="product-paying-status">${o.status}</td>
                                        <td class="product-paying-price">
                                            <fmt:formatNumber type="number" pattern="###,###" value="${o.totalPrice + 30000}" />đ
                                        </td>
                                        <td class="product-paying-detail"><a href="loadOrderDetail?oID=${o.id}">
                        ...
                        <p class="cus-info-note"><strong>Note:</strong>Tất cả đơn hàng sẽ được xử lí và giao đến quí khách
                            ...
                            quí khách đã đặt hàng tại Group-1-shop!</p>
                ...
                <div class="col-xs-12 col-lg-4">
                    <div class="cus-info">
                        <div class="cus-heading-group">
                            ...
                            <a href="home">
                                <img class="mini-logo" src="./assert/img/Mini_Logo.png"
                                     alt="logo" />
                            </a>
                        </div>
