                ...
                <form action="orderLoad" method="get" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="cart-error-message disable ${cartErrorMessage == true ? "active" : ""}">Bạn vui lòng chọn sản phẩm trước khi thanh toán!!!</div>
                            <c:if test="${sessionScope.listCartSize == 0}">
                                <div class="row mb-3 padding ">
                                    <div class="col-xs-12 no-found-product-group">
                                        <img src="./assert/img/no_product_found.png" alt="no found product!"/>
                                    ...
                                    <table class="table table-bordered align-middle">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listCart}" var="c">
                                                <tr>
                                                    <td scope="row">
                                                        <input class="product-cart-add" name="isPayed" type="checkbox" value="${c.productID},${c.cusID},${c.size}">
                                                    </td>
                    ...
                    <c:if test="${sessionScope.listCartSize != 0}">
                        ...
                        <div class="row justify-content-space-between">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn main-btn btn-add-cart">TIẾN HÀNH THANH TOÁN</button>
                            </div>
                        </div>
                    </c:if>
                </div>
