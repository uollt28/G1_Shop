    ...
    <head>
        ...
        <style>
            * {
            ...
            .category-btn .btn-category a {
                color: #555;
                font-weight: bold;
            }

            .category-btn .btn-category:hover {
                background-color: #999;
            }

            .category-btn .btn-category:hover a {
                color: white !important;
            }
                        ...
                        <div class="col-md-12">
                            <div class="category">
                                ...
                                <c:forEach items="${requestScope.listCategory}" var="i">
                                    <button class="btn btn-category ${activeByID == i.ID ? "active" :""}">
                                        <a href="category?categoryId=${i.ID}">${i.name}</a>
                                    </button>
                                </c:forEach> 
                            </div>
                        </div>
                ...
                <c:if test="${noFoundProduct == 0}">
                    <div class="row mb-3 padding ">
                        <div class="col-xs-12 no-found-product-group">
                            <img src="./assert/img/no_product_found.png" alt="alt"/>
