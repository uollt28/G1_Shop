...
<html lang="en">
        ...
        <div class="container">
            <form action="updateProduct" method="get">
                ...
                <div class="form-group form-btn-group">
                    ...
                    <button class="main-btn primary-btn" type="submit" onclick="return showMessageUpdate();">Update product</button>
                </div>
            </form>
        </div>
    </body>
    <script>
        function showMessageUpdate() {
            var result = confirm("Are you sure to update this product?");
            if (result) {
                return true;
            } else {
                return false;
