    ...
    <head>
        ...
        <style>
            * {
            ...
            .form-paying-btn-group button a, .form-paying-btn-group .btn-order {
                font-size: 14px;
                font-weight: bold;
            }
                    ...
                    <div class="col-xs-12 col-lg-8">
                                        ...
                                        <c:if test="${o.product_id == p.ID}">                                               
                                            <tr> 
                                                ...
                                                <td class="product-paying-price">
                                                    <fmt:formatNumber type="number" pattern="###,###" value="${o.price * o.quantity}" />đ
                                                </td>
                                            </tr>
                                        </c:if>
                                    </c:forEach>
                        ...
                        <div class="form-paying-btn">
                            <p>
                                ...
                                <strong>Group-1-shop</strong> store. Chúc quí khách may mắn.
                            </p>
